...
# # UPS MONITORING
# Welcome to the UPS monitoring. Make sure to follow the installation instructions before you start.
# # Imports
...
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'cam{}.jpg'.format(61)) ]
...
import cv2
img = cv2.imread(os.path.join(PATH_TO_TEST_IMAGES_DIR, 'cam{}.jpg'.format(61)))
...
cropped1 = img[yminn: (ymaxx), xminn:(xmaxx)]
...
with open('colorcode.csv', 'a') as csvfile:
    colorcode = csv.writer(csvfile, delimiter=' ')
#                            quotechar='|', quoting=csv.QUOTE_MINIMAL)
    colorcode.writerow([[os.path.join(PATH_TO_TEST_IMAGES_DIR,'cam{}.jpg'.format(61), green, yellow, red)]])
